            ...
            <form method="POST" action="{{route('users.update', $user->id)}}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group" style="flex: 1; margin-left: 10px;">
                        ...
                        <input value="{{$user->first_name}}" autocomplete="off" name="first_name" id="first_name" class="input" type="text" placeholder="Fallou" required>
                        <div></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group" style="flex: 1; margin-left: 10px;">
                        ...
                        <input value="{{$user->phone}}" autocomplete="off" name="phone" id="phone" class="input" type="tel" placeholder="775441234" required>
                        <div></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group" style="flex: 1; margin-left: 6px;">
                        ...
                        <input value="{{$user->address}}" autocomplete="off" name="address" id="address" class="input" type="text" placeholder="Dakar, Guediawaye" required>
                        <div></div>
                    </div>
                    <div class="input-group" style="flex: 1; margin-left: 10px;">
                        <label for="address" class="label">Numéro de la carte</label>
                        <input value="{{$user->id_card_number}}" autocomplete="off" name="id_card_number" id="id_card_number" class="input" type="text" placeholder="XDF654648516" required>
                        <div></div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="input-group" style="flex: 1; margin-left: 6px;">
                        ...
                        <input value="{{$user->department}}" list="languages" id="language_id" class="input-datalist" name="departement" required>
